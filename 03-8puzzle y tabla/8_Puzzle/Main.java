public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\n" + "=".repeat(70));
        System.out.println("TABLA COMPARATIVA DE ALGORITMOS - 8 PUZZLE");
        System.out.println("=".repeat(70));
        System.out.printf("%-25s %15s %20s%n", "Algoritmo", "Tiempo (s)", "Nodos Expandidos");
        System.out.println("-".repeat(70));
        System.out.printf("%-25s %15.6f %20d%n", "Búsqueda en Anchura", tAnchura, nAnchura);
        System.out.printf("%-25s %15.6f %20d%n", "Búsqueda en Profundidad", tProfundidad, nProfundidad);
        System.out.printf("%-25s %15.6f %20d%n", "Costo Uniforme", tCostoUniforme, nCostoUniforme);
        System.out.printf("%-25s %15.6f %20d%n", "A*", tAEstrella, nAEstrella);
        System.out.println("=".repeat(70));
    }
